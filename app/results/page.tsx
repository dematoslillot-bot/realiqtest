  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f] text-[#f0ede8]">
      ...
      <div className="max-w-2xl mx-auto px-6 py-12 text-center">
        {/* IQ Score */}
        <p className="text-xs tracking-widest uppercase text-[#8a8890] mb-3">Your RealIQ Result</p>
        ...
        <div className="max-w-sm mx-auto mt-6">
          <div className="h-1 bg-[rgba(201,169,110,0.12)] rounded-full overflow-hidden">
            <div className="h-full bg-[#c9a96e] rounded-full transition-all duration-1000" style={{ width: `${meterFill}%` }} />
          </div>
        ...
        <p className="text-sm text-[#8a8890] mt-4">You scored {score} out of {total} questions</p>
        ...
        <div className="mt-10 text-left">
          ...
          <div className="flex flex-col gap-3">
            {CATEGORIES.map((cat, i) => {
              ...
              const blurred = i >= 3;
              return (
                <div key={i} className={`flex items-center gap-4 p-3 bg-[#111118] border border-[rgba(201,169,110,0.2)] rounded transition-all ${blurred ? "blur-sm opacity-40 select-none" : ""}`}>
