    ...
    <Link href="/" style={{
      ...
      <svg width="26" height="22" viewBox="0 0 28 24" fill="none"
        ...
        <path d="M14 2 C14 2 8 2.5 5.5 5.5 C3 8.5 3 11 4 13.5 C5 16 7 17 8 19 C9 20.5 9.5 21.5 11.5 21.5 C12.5 21.5 13.5 21 14 20.5"
          stroke="#5B4FFF" strokeWidth="1.6" fill="rgba(91,79,255,0.08)" strokeLinecap="round" strokeLinejoin="round"/>
        <path d="M14 2 C14 2 20 2.5 22.5 5.5 C25 8.5 25 11 24 13.5 C23 16 21 17 20 19 C19 20.5 18.5 21.5 16.5 21.5 C15.5 21.5 14.5 21 14 20.5"
          stroke="#00F5D4" strokeWidth="1.6" fill="rgba(0,245,212,0.06)" strokeLinecap="round" strokeLinejoin="round"/>
        <path d="M7 10 C8.5 8 10.5 9 11.5 11" stroke="#5B4FFF" strokeWidth="0.85" strokeLinecap="round" opacity="0.65"/>
        <path d="M6.5 14.5 C8.5 13 10 15 10.5 17" stroke="#5B4FFF" strokeWidth="0.85" strokeLinecap="round" opacity="0.55"/>
        <path d="M21 10 C19.5 8 17.5 9 16.5 11" stroke="#00F5D4" strokeWidth="0.85" strokeLinecap="round" opacity="0.65"/>
        <path d="M21.5 14.5 C19.5 13 18 15 17.5 17" stroke="#00F5D4" strokeWidth="0.85" strokeLinecap="round" opacity="0.55"/>
        <line x1="14" y1="2" x2="14" y2="20.5" stroke="rgba(0,245,212,0.25)" strokeWidth="0.7" strokeDasharray="2,2.5"/>
        <circle cx="8.5" cy="10" r="1.3" fill="#5B4FFF" opacity="0.85">
          <animate attributeName="opacity" values="0.85;1;0.5;1;0.85" dur="2.2s" repeatCount="indefinite"/>
        </circle>
        <circle cx="19.5" cy="10" r="1.3" fill="#00F5D4" opacity="0.75">
          <animate attributeName="opacity" values="0.75;1;0.5;1;0.75" dur="2.8s" repeatCount="indefinite" begin="0.6s"/>
        </circle>
        <circle cx="7.5" cy="15" r="1.1" fill="#5B4FFF" opacity="0.7">
          <animate attributeName="opacity" values="0.7;1;0.4;1;0.7" dur="1.9s" repeatCount="indefinite" begin="1.1s"/>
        </circle>
        <circle cx="20.5" cy="15" r="1.1" fill="#00F5D4" opacity="0.65">
      ...
      Real<span style={{ color: "#5B4FFF", textShadow: "0 0 14px rgba(91,79,255,0.8)" }}>IQ</span>Test
    </Link>
  );
}
